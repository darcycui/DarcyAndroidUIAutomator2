...
from utils.uiautomator2.view_exists import exists_by_id, exists_by_text, exists_by_description
from utils.uiautomator2.view_get import get_view_by_class_name, get_view_by_text
...
def login(
    ...
    try:
        ...
        verify_code_message = wait_view_text_by_text_contains(device, 'Login code:', 120)
