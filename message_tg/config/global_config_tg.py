...
CHAT_USER_NAME_IN_HUAWEI = 'Ciii Home 5786'
...
DEVICE_ID_OUT_HUAWEI = 'NAB0220416042561'
COUNTRY_NUMBER_OUT_HUAWEI = '852'
PHONE_NUMBER_OUT_HUAWEI = '67415786'
CHAT_USER_NAME_OUT_HUAWEI = 'Ciii Darcy 7407'
ROOT_NAME_OUT_HUAWEI = 'ANA-AN00'
